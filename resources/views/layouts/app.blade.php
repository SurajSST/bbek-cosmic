...
<body class="min-h-full bg-slate-50 text-slate-900 dark:bg-[#070a12] dark:text-slate-100 antialiased selection:bg-indigo-500 selection:text-white transition-colors duration-150 select-none font-sans">
    <div x-data="{ 
        sidebarOpen: false, 
