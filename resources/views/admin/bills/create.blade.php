...
<div class="max-w-4xl mx-auto space-y-6" x-data="{
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-xs text-slate-500 dark:text-slate-400">Record a new bill entry by filling out details and capturing or attaching the bill image.</p>
        </div>
    ...
    <div class="bg-white dark:bg-slate-900 rounded-2xl border border-slate-200 dark:border-slate-800 p-6 sm:p-8 shadow-sm">
        ...
        <form method="POST" action="{{ route('admin.bills.store') }}" enctype="multipart/form-data" class="space-y-8">
            @csrf
            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="bill_number" name="bill_number" value="{{ old('bill_number', 'BILL-' . strtoupper(Str::random(6))) }}" required
            ...
            <!-- Section 2: Bill Image Upload & Camera Integration -->
            <div class="space-y-4 pt-2">
                <h3 class="font-bold text-slate-900 dark:text-white text-sm border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center justify-between">
                    <span class="flex items-center gap-2">
                        <span class="w-2.5 h-2.5 rounded-full bg-indigo-600"></span>
                        Upload Bill Image / Receipt <span class="text-rose-500">*</span>
                    </span>
                ...
                <div class="p-6 rounded-2xl border-2 border-dashed border-slate-300 dark:border-slate-700 bg-slate-50/60 dark:bg-slate-800/40 text-center space-y-4">
                    ...
                    <input type="file" id="bill_image" name="bill_image" accept="image/*" class="hidden" @change="onFileSelect($event)">
                    ...
                    <template x-if="imagePreviewUrl">
                        <div class="space-y-3">
                            <div class="relative max-w-md mx-auto rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-md bg-slate-950/40 group">
                                <img :src="imagePreviewUrl" alt="Bill Preview" class="w-full max-h-72 object-contain mx-auto py-2">
                                <div class="absolute inset-0 bg-slate-950/60 opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-3">
                                    ...
                                    <button type="button" @click="document.getElementById('bill_image').click()" class="px-3 py-1.5 rounded-xl bg-white text-slate-800 text-xs font-semibold hover:bg-slate-100 shadow">
                                        📁 Choose File
                                    </button>
                                </div>
                            </div>
                    ...
                    <template x-if="!imagePreviewUrl">
                        <div class="space-y-4 py-4">
                            ...
                            <div>
                                <h4 class="text-sm font-bold text-slate-800 dark:text-slate-200">Upload or Capture Bill Image</h4>
                            ...
                            <div class="flex flex-wrap items-center justify-center gap-3 pt-2">
                                ...
                                <button type="button" @click="document.getElementById('bill_image').click()" class="inline-flex items-center gap-2 px-4 py-2.5 rounded-xl bg-white dark:bg-slate-800 border border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 text-xs font-semibold hover:bg-slate-100 dark:hover:bg-slate-700 transition">
            ...
            <!-- Section 3: Optional Proof & Remarks -->
            <div class="space-y-4 pt-2">
                <h3 class="font-bold text-slate-900 dark:text-white text-sm border-b border-slate-200 dark:border-slate-800 pb-2 flex items-center gap-2">
                    <span class="w-2.5 h-2.5 rounded-full bg-indigo-600"></span>
                    Proof & Notes
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <textarea id="remarks" name="remarks" rows="2" placeholder="Brief notes or references..."
