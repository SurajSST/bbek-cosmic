            ...
            <div class="space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" id="billed_via" name="billed_via" value="{{ old('billed_via', $salesOrder->billed_via) }}" required
                    ...
                    <div>
                        ...
                        <input type="text" id="billed_to" name="billed_to" value="{{ old('billed_to', $salesOrder->billed_to) }}" required
                            class="w-full px-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500">
                    </div>
