        ...
        <div class="max-w-4xl mx-auto space-y-6">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2 text-xs">
                    ...
                    <span class="font-bold text-slate-900 dark:text-white">Edit {{ role.name }}</span>
                </div>
            ...
            <div class="glass-card rounded-3xl p-6 sm:p-8 shadow-sm border border-slate-200/80 dark:border-slate-800/80 space-y-6">
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" v-model="form.name" required class="w-full px-3.5 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-xs font-semibold text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 max-w-md" />
