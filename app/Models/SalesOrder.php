...
class SalesOrder extends Model
{
    ...
    /**
     * Scope to search by Sales Order (SO), SO From, Bill No, Billed From or Billed To.
     */
    ...
    {
        $allowedColumns = ['so_number', 'so_from', 'billed_from', 'billed_to', 'billed_status', 'bill_no', 'created_at'];
