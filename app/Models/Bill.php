...
class Bill extends Model
{
    ...
    /**
     * User who uploaded/created the bill.
     */
    ...
    /**
     * Scope to search by Bill Number, Billed From, or Billed To.
     */
    ...
    {
        $allowedColumns = ['bill_number', 'billed_from', 'billed_to', 'status', 'amount', 'created_at'];
